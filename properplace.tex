...
\commentOCf{Je suis un peu triste que Morgenstern ait disparu en tant qu’illustration, je trouvais que ça donnait un aspect concret à notre discussion. (Il est vrai qu’on peut hésiter entre cette catégorie et la suivante, où je crois qu’on l’avait placé initialement, mais je trouve qu’il serait bien ici finalement.)}
...
But, as opposed to proponents of $A_E$, Habermas provides foundations to entrench his $\mathscr{N}_{H}$\begin{changebar}, and these foundations provide Habermas with a reason to claim that a justification based on these foundations is a good justification, which permit to go beyond attitude $A_J$. \end{changebar}
