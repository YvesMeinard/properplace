...
\commentOC{“answer this question”, isn’t it? (and the whole sentence is new, I think).}The present article attempts to contribute to answer \begin{changebar}to\end{changebar} this question.
...
\commentOC{La phrase précédente est bien là, je trouve. J’effacerais la suivante. C’est une section de review, donc je ne crois pas qu’on doive expliquer en détail en quoi on va plus loin que l’existant. Ou alors, dire simplement que nos arguments et notre focus sont différents ?} However, our topic is broader, since we are interested here in the role that norms $N$ play in a decision support process as a whole, not only in models, and we introduce a distinction (between $A_I$ and $A_J$) without conterpart in \possessivecite{le_menestrel_ethics_2004} typology.
...
To illustrate this idea, consider \possessivecite{arrow_social_2012} theorem. \begin{changebar}(This illustration has been suggested to us by Ulle Endriss.)\end{changebar}
...
\commentOCf{Je suis un peu triste que Morgenstern ait disparu en tant qu’illustration, je trouvais que ça donnait un aspect concret à notre discussion, et je trouve son propos particulièrement parlant, et c’est pas mal de faire au moins une petite référence aux débats autour du livre d’Allais dans un article comme celui-ci. (Il est vrai qu’on peut hésiter entre cette attitude et la suivante, où on l’avait placé initialement, mais je trouve qu’il serait bien ici finalement.) Je dirais que \citet[p. 180]{morgenstern_reflections_1979} can, under some interpretation of his text, be considered as a proponent of this attitude, as he writes that “[expected utility] theory, as formulated by the von Neumann-Morgenstern axioms, is normative in the sense that the theory is ‘absolutely convincing’”. Si un reviewer trouve EUT flawed, on peut simplement lui répondre qu’on ne prend pas position sur la qualité d’EUT mais simplement qu’on utilise ce propos pour illustrer.}
...
\begin{changebar}(or, equivalently, to limit themselves to use assertions that are ``warranted'')\end{changebar}, is \commentOC{“hence” here feels unjustified. We have to say first that these authors take it as a self-evident premise, if this is what we mean. But saying it in this way would seemingly contradict the previous § where we say that these authors insist that justification is necessary (thereby do not consider it self-evident). I think we should drop the “self-evident” stuff and say (if true) that these authors 1) do not spell out precisely the principles on which the need of justification rests and 2) (as a consequence perhaps) leave the notion of justification underdetermined. As an alternative (that I’d favor), we drop this sentence, and move the sentence referring to Ormerod with the crowd above. I think saying directly that this notion is too vague is simple and convincing.} hence often taken as a self-evident, unquestionable premise. 
...
\possessivecite{habermas_moralbewustsein_1983} “weak” transcendental deduction of the tenets of “discourse ethics” from communicative action is particularly interesting in this respect. 
...
Habermas's reasoning \begin{changebar}provides criteria of sorts to elaborate the notion of justification, by anchoring it in his philosophy of society, which refers in turn to his theory of communicative action.
...
But, as opposed to proponents of $A_E$, Habermas provides foundations to entrench his $\mathscr{N}_{H}$, and these foundations provide Habermas with a reason to claim that a justification based on these foundations is a good justification, which permit to go beyond attitude $A_J$. \end{changebar}
...
\commentOC{J’ai restauré tes trois contre-objections, on devrait trouver de la place pour ça.}
...
\commentOCf{Le § précédent dit essentiellement la même chose concernant le single DM, sauf que dans le § précédent il y a moins de références. Il faut sans-doute fusionner.}
