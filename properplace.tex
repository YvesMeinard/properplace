...
\commentOCf{Cette dernière phrase un peu difficile à comprendre à mon avis. Je ne suis pas sûr de ce que tu voulais dire. Je propose qqch comme ça à la place. “However, we are interested here in the role that norms $N$ play in a decision support process as a whole, not only in models; and we think it is important to discuss the contents which should be put into the notion of justification and the grounds for such requirements. This is what the rest of this article will attempt to do.”}
...
\commentOCf{Je l’ignore. Une fausse manœuvre ? Tout ce que je peux te dire (merci \texttt{git blame}), c’est que c’est ton commit 5784635b, \og{}v1 almost ok\fg{}, qui a déplacé ce § qui se trouvait alors juste avant l’exemple 1.}
