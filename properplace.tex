...
\textcolor{blue}{The need to address this question is illustrated by \citet{jackson_towards_1999}, who spells out in more details the resources that can be used to articulate justification, but does not explore how to ensure that an argument based on his guidelines qualifies as a justification, which precisely is our topic.}
