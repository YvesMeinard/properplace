...
\title{Justification and decision analysis}\commentYM{si notre manière de parler des sciences de la décision te mettais mal à l'aise, j'imagine que le titre aussi ! changer pour ``justification and applied decision analysis'' ?}\commentOCf{Comme j’aime les titres courts, je propose celui-ci, mais ta proposition me va aussi, si tu la préfères.}
...
\commentOCf{Cet ajout me semble faire plus de mal que de bien. Si le lecteur ne comprend pas a priori la pertinence de s’interroger sur les normes, dire ça n’aide pas (on a envie de répondre que c’est une norme évidente, sous entendue, et de nous prendre pour des coupeurs de cheveux en quatre). Je ne vois pas vraiment de manière très courte de convaincre que la question est importante. À la réflexion, mieux vaut je pense ne rien dire et espérer que le lecteur poursuivra la lecture suffisamment pour se convaincre qu’elle l’est.}
...
\commentOCf{Ok si tu insistes, mais la dernière me semble importante, et Denis (un expert en Roy s’il en est) n’avait pas compris pourquoi on disait ça, donc il semble utile de s’étendre un poil sur cet aspect.}
