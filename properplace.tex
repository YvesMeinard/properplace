...
The immense literature on the normative underpinnings of economic science \citep{buchanan_positive_1959,sen_nature_1967,dwyer_scientific_1985, heath_value_1994,mongin_value_2006,sen_idea_2009,baujard_value_2013} tackles issue which are, to some undeniable extent, linked with the ones that we explore here. However, the applied literature still expresses diametrically opposed stances on these matters \citep{spash_bulldozing_2015, scharks_dont_2016}, \commentYM{je veux bien qu'on vire cet exemple, mais alors en as-tu un autre ?} which suggests that clarifications are still needed, especially when it comes to the practice of producing recommendations, as opposed to the theoretical aspects on which the above literature is mainly focussed (\citet{baujard_value_2013} being a noticeable exception).
...
Our aim  this models aims to provide a general account of the normative stance that we should take as decision scientists, and therefore is undoubtedly very ambitious in its scope, we emphasize that it is also very modest in many respects. It does not provide a metric, no generally applicable mechanical means to compare any two applications of decision sciences without discussions. There is bound to be myriads of hard cases where one application of decision science will appear better than another on some respect, but worse on another respect.


\commentOCf{il faudrait faire remarquer que notre article dit 1) qu’on peut toujours faire mieux dans la justification 2) qu’il faut se souvenir que la recommendation ne tient que pour autant que N tienne 3) qu’il faut aider le DM à savoir comment N est valide, ce que tout le monde reconnaitra que (presque) personne ne fait actuellement, et pour lequel il n’existe pas de démarche scientifique, manque que cet article commence à combler. nous proposons de construire une démarche scientifique plus précise et outillée, qui réduirait l’énergie requise pour justifier, tout en admettant effectivement l’incrémentalisme de la démarche (ça tu le dis)}
