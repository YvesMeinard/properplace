...
However, because ``most contributions to the ‘ethics’ of OR%\ac{OR}
...
this literature barely explores how to make sure that the $N$ underlying recommendations do not conflict with DM%\acp{DM}
' values.
...
We begin (in \cref{sec:existing}) by exploring attitudes of decision analysts with respect to $N$ in the literature. 
