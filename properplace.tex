...
\commentYM{si on enlève ta phrase ``While etc.'', on peut ajuster la suivante en disant : ``By contrast, we claim that a crucial task is to help the DM to make up her mind about norms underlying recommendations and we ague that this can be achieved by justifying these norms, in a very specific sense of ``justifying'' which we elaborate.}\commentOCf{D’accord, mon consensual était maladroit, mais c’est un détail. Si les gens qui ont réfléchi à la question sont d’accord qu’il faut justifier, ça suffit pour qu’il ne soit plus légitime de notre part de considérer comme un apport à la litérature de dire qu’il faut justifier : on doit partir de l’opinion des experts du sujets, pas de l’opinion de l’homme de la rue (ou même de l’analyste très sophistiqué qui ne s’intéresse pas à ces questions). Je pense surtout important d’insister sur “it is crucial to determine precisely which notion of justification should be employed, and why” et de montrer qu’on ne trouve pas que notre apport soit principalement de dire qu’il \og{}faut justifier\fg{} mais plutôt de dire que \emph{non seulement} il faut justifier, mais il faut \emph{surtout} dire comment et pourquoi. Dans ta proposition, cette insistance aurait essentiellement disparu, et on se rapprocherait de la version précédente qui avait suscité le malentendu de R2, en reléguant notre élaboration du \og{}very specific sense of ``justifying''\fg{} en fin de phrase, comme un bonus, alors qu’elle devrait être le centre d’au moins une phrase (et de préférence de plusieurs). J’ai tenté une nouvelle formulation.}
