...
\begin{changebar}
\citet{churchman_operations_1970} is considered to be the first leading author to have insisted on the importance of value judgements in OR \citep{ormerod_operational_2013}, but this pervasiveness of these $N$ is now increasingly acknowledged by OR academics and practitionners \citep{brans_ethics_2007}, which has led to a florishing literature on ethics in OR. 
In addition to being pervasive, the complexity of value judgements and their contexts of application create practical dilemmas which cannot be easily solved using general ethical guidelines or codes of conduct \citep{taket_undercover_1994}, and call for interdisciplinary collaboration involving basic research in philosophy, applied ethics and OR \citep{picavet_opportunities_2009}. \end{changebar} This is because ``OR%\ac{OR}  
...
There is hence a large consensus, in both OR%\ac{OR} 
...
analysts have a duty to remain neutral with respect to DM%\acp{DM} 
...
\end{changebar}
A weaker form of neutrality, encapsulated in the requirement to refrain from being \emph{dogmatic, paternalist, proselyte, or authoritarian}, by imposing $N$ we favor in our interaction with DM%\acp{DM}
...
. This methodological choice is motivated by the fact that interpretative approaches allow articulating refined judgments on the meaning of practices such as OR (echoing the importance of narrative analysis to understand the meaning of practices such as OR \citep{white_death_1994}).
...
In that sense, a more systematic methodology, based on a quantitative review of the literature would certainly provide complementar insights. 
