...
\commentYM{je n'ai rien contre remettre Vénus ici, et je suis d'accord que l'argument du reviewer est bidon. J'enlève juste le ``is normative'' de la citation, car ce terme est une boîte de Pandore. \og{}\citet[p. 180]{morgenstern_reflections_1979} can, in a plausible reading, be considered to be a proponent of this attitude, for example when he writes that 
“[expected utility] theory, as formulated by the von Neumann-Morgenstern axioms (...) is ‘absolutely convincing’”.\fg{}}
...
by introducing a “weak” transcendental deduction of the tenets of “discourse ethics” from communicative action \citep{habermas_moralbewustsein_1983}. 
...
We begin with the notion of justification in general, admitting that, at this level of generality, a justification requirement is innocuous. 
...
%This will then enable us
 to sharpen our understanding of the idea of a \emph{satisfactory justification} in our context.
