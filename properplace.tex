...
\commentYM{je ne suis pas d'accord avec ta phrase ``While it is consensual...''. Il me semble au contraire que plein de gens pensent qu'on s'en fout de justifier, parce que ce qui compte c'est que ``ça marche'', et que de toute façon on n'a pas le temps de justifier, et puis les gens c'est des cons, ils peuvent pas comprendre. Je pense donc pas qu'on puisse dire que l'exigence de justification est consensuelle. Elle est consensuelle dans un tout petit groupe de gens qui ont réfléchi à ces question, et je pense que quiconque accepte d'en discuter finit par se dire qu'au fond de lui il accepte une exigence de justification. Mais il y a un gouffre entre dire ça et dire que l'exigence de justification est consensuelle}

While it is consensual that, in a somewhat undetermined sense, justifying is better than not justifying, we argue that it is crucial to determine precisely which notion of justification should be employed, and why. 
