...
In addition to being pervasive, according to some authors (e.g. \citet{taket_undercover_1994}), their complexity create practical dilemmas which cannot be easily solved using general ethical guidelines or codes of conduct.
\end{changebar}



The importance of these normative elements $N$ is largely acknowledged in the OR %\ac{OR}
literature \citep{picavet_opportunities_2009}.
...
There is a large consensus, in both OR%\ac{OR}
...
\possessivecite{gass_ethical_2009} A CHANGER ``Oath of Prometheus'' similarly includes a reference to DM%\ac{DM}
’s goals 
\begin{changebar}
...
\begin{changebar}
Our approach here is interpretative: we infer a proposal for a classification of attitudes with respect to $N$ based on our knowledge of the literature in economics, philosophy and OR%\ac{OR}
.
