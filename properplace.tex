...
% even points the need for analyst to ask themselves ``To what extent am I confortable with the values implicit in particular methodologies?'' \citet{mingers_towards_1997} (p. 421).
...
A weaker form of neutrality, encapsulated in the requirement to refrain from being \emph{dogmatic, paternalist, proselyte, or authoritarian}, by imposing $N$ we favour in our interaction with \acp{DM}, is hence largely accepted.
...
\citet[p. 180]{morgenstern_reflections_1979} can, in a plausible reading, be considered to be a proponent of this attitude, for example when he writes that 
...
$A_J$ hence appears unsatisfactory because it takes for granted that the notion of justification is transparent and unproblematic, whereas on due reflexion this notion appears ambiguous.
\end{changebar}
