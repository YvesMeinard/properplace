...
We argue that the various attitudes found in the literature share a critical blind spot: they neglect or trivialize the task to help the DM%\ac{DM}
 to make up her mind about $N$. At best they recommend that analysts' recommendations should be ``justified'', without clarifying precisely the concept of ``justification'' they use. \commentOCf{Ceci peut être mal compris : on peut trouver que certains auteurs  clarifient leur concept de justification (en donnant une liste de choses à faire pour justifier). J’ajouterais : “or without giving fundamental grounds for adopting a specific notion of justification among the many possible ones”, ou “or without justifying in turn the specific choice of actions they promote”, ou qqch comme ça.}
While it is consensual that, in a somewhat undetermined sense, justifying is better than not justifying, we argue that it is crucial to determine precisely which notion of justification should be employed, and why. We claim that a crucial task is to help the DM to make up her mind about norms underlying recommendations, which constitute our starting point for promoting justification as a possible solution and specifying its sense.
...
In \cref{sec:recomm}, in order to overcome the shortcomings of existing, undetermined references to ``justification'', we elaborate the notion of justification that is needed.
\Cref{sec:recomm} hence spells out a series of requirements that justifications should satisfy, stemming partly from the shortcomings of attitudes reviewed in the previous section. \commentOC{Or shorter: “In \cref{sec:recomm}, we therefore elaborate the notion of justification that is needed by spelling out a series of requirements that justifications should satisfy, stemming partly from the shortcomings of attitudes reviewed in the previous section”. (I prefer the shorter one, I let you judge.)}
...
The third subsection then presents a set of practical rules that materialize these requirements and participate in fleshing them out. These practical rules specify the attitude that a decision analyst should have, if he sets himself the task to produce \emph{satisfactory justifications} for the $N$ grounding his $R$ (our ambition here is to clarify a higher level norm thanks to this practical rule, but notice that elaborating a precise and complete typology of norms falls beyond the scope of this article).
