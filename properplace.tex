...
To illustrate this idea, consider \citeauthor{arrow_social_2012}’s \citeyearpar{arrow_social_2012} theorem. \begin{changebar}(This illustration has been suggested to us by Ulle Endriss.)\end{changebar}
...
Similarly, our \cref{it:argue} echoes \citet{funtowicz_science_1993}'s claim that in post-normal science ``values are not presupposed but made explicit'', and our \cref{it:criticize} is reminiscent of \citeauthor{funtowicz_science_1993}'s ``extended peer community''.
