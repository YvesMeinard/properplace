...
The importance of these normative elements $N$ is largely acknowledged in the OR%\ac{OR}
 literature \citep{churchman_operations_1970,taket_undercover_1994,brans_ethics_2007,picavet_opportunities_2009}, 
because ``OR%\ac{OR}
...
\possessivecite{gass_ethical_2009} ``Oath of Prometheus'' similarly starts with a reference to DM%\ac{DM}
’s goals.
...
Our approach to establish this typology is interpretative: we infer a proposal for a classification based on our knowledge of the literature in economics, philosophy and OR%\ac{OR}
.
